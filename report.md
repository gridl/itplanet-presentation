...
## 9 слайд -- Стек ПО для виртуального хостинга

Что касается виртуального хостинга, тут все тот же стандартный стек Linux, Apache, MySQL, PHP, однако MySQL в нашем случае заменен на форк Percona, который является более производительным.
